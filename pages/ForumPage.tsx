  ...
  return (
    <div className="container mx-auto p-4 sm:p-8 max-w-4xl">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h1 className="text-3xl sm:text-4xl font-bold text-white">Fórum</h1>
        <Link to="/forum/create-post" className="w-full sm:w-auto">
          <button className="bg-purple-600 hover:bg-purple-500 text-white font-bold py-2 px-4 rounded w-full sm:w-auto">
            Criar Novo Post
          </button>
        </Link>
      </div>

      <div className="flex items-center space-x-2 sm:space-x-4 mb-6 border-b border-gray-700 pb-4">
        <button
